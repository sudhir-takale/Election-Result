...
public class ElectionDeskControllerTest extends TestBase {
    ...
    @Test
    void shouldBeAbleToProcessInputFile() throws InvalidPartyCodeException, InvalidConstituencyFoundException, InvalidInputLineException {
        // arrange
    ...
    @Test
    void shouldReturnBadResponseIfFilePathIsEmpty() throws InvalidPartyCodeException, InvalidConstituencyFoundException, InvalidInputLineException {
        // arrange
        String filePath = "";
